...
/**
 * Created by Alexis on 18/02/2018.
 */

public class VehiculeEnnemi5 {
    ...
    public VehiculeEnnemi5(final Context c)
    {
...
//        Log.d("ratio",Double.toString(ratio));
        ...
        img = setImage(mContext,R.drawable.blacknologo,vehiculeEnnemiW,vehiculeEnnemiH); //vehiculeEnnemi3
