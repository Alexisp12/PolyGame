...
public class PanneauNougaro {private BitmapDrawable img=null; // image du panneauNantes
    ...
    public PanneauNougaro(final Context c)
    {
...
//        heightOriginal=bitmap.getHeight();
    ...
    public void resize(int wScreen, int hScreen) {
        ...
        Drawable dr = mContext.getResources().getDrawable(R.drawable.nougaro);
        Bitmap bitmap = ((BitmapDrawable) dr).getBitmap();
        widthOriginal=bitmap.getWidth();
        heightOriginal=bitmap.getHeight();
        ...
        img = setImage(mContext,R.drawable.nougaro,panneauNantesW,panneauNantesH); //panneauNantes3
