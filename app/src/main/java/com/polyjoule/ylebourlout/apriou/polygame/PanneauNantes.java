...
public class PanneauNantes {
    ...
    public PanneauNantes(final Context c)
    {
...
//        heightOriginal=bitmap.getHeight();
    ...
    public void resize(int wScreen, int hScreen) {
        ...
        Drawable dr = mContext.getResources().getDrawable(R.drawable.nantes);
        Bitmap bitmap = ((BitmapDrawable) dr).getBitmap();
        widthOriginal=bitmap.getWidth();
        heightOriginal=bitmap.getHeight();
        ...
        img = setImage(mContext,R.drawable.nantes,panneauNantesW,panneauNantesH); //panneauNantes3
