...
public class PanneauLondon {private BitmapDrawable img=null; // image du panneauNantes
    ...
    public PanneauLondon(final Context c)
    {
...
//        heightOriginal=bitmap.getHeight();
    ...
    public void resize(int wScreen, int hScreen) {
        ...
        Drawable dr = mContext.getResources().getDrawable(R.drawable.longon);
        Bitmap bitmap = ((BitmapDrawable) dr).getBitmap();
        widthOriginal=bitmap.getWidth();
        heightOriginal=bitmap.getHeight();
        ...
        img = setImage(mContext,R.drawable.longon,panneauNantesW,panneauNantesH); //panneauNantes3
