...
public class PanneauRoterdam {private BitmapDrawable img=null; // image du panneauNantes
    ...
    public PanneauRoterdam(final Context c)
    {
...
//        heightOriginal=bitmap.getHeight();
    ...
    public void resize(int wScreen, int hScreen) {
        ...
        Drawable dr = mContext.getResources().getDrawable(R.drawable.rotterdam);
        Bitmap bitmap = ((BitmapDrawable) dr).getBitmap();
        widthOriginal=bitmap.getWidth();
        heightOriginal=bitmap.getHeight();
        ...
        img = setImage(mContext,R.drawable.rotterdam,panneauNantesW,panneauNantesH); //panneauNantes3
