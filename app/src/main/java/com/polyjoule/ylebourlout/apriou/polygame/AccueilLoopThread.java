...
public class AccueilLoopThread extends Thread {
    ...
    private final AccueilView view; // l'objet SurfaceView que nous verrons plus bas
    ...
    public AccueilLoopThread(AccueilView view) {
        this.view = view;
    }
