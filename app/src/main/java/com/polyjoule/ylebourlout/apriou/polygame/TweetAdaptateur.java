...
public class TweetAdaptateur extends BaseAdapter {
    ...
    public TweetAdaptateur(Context context, List<String> aPseudo,List<String> aStatus, List<Bitmap> aPP) {
        mContext = context;
        pseudo = aPseudo;
        status = aStatus;
        pp=aPP;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            layoutItem = (RelativeLayout) mInflater.inflate(R.layout.tweet_update, parent, false);
        } else {
