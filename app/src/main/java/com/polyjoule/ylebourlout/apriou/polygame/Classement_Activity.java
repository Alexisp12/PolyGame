...
public class Classement_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userInfoListView = (ListView) findViewById(R.id.listViewUI);
        //initializing views
        ...
        if(firebaseAuth!=null) {
            if (firebaseAuth.getCurrentUser() != null) {
                ...
                if (users.size() != 0) {
                    ...
                    RankItemAdapter adapter = new RankItemAdapter(this, users);
